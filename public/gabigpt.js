document.addEventListener('DOMContentLoaded', () => {
    ...
    const produtos = [
      { "id": 1, "nome": "🟢 SUPER SLIM X 🟢", "preco": 169.90, "imagem": "https://www.gtfit.store/assets/produtos/slimx.png", "descricao_curta": "Redução do apetite, diminuição da absorção de gordura, melhora da composição corporal e redução do inchaço.", "link_loja": "https://www.gabrielatorraca.com.br/suplementos-naturais/emagrecedores/slim-super-x" },
      { "id": 2, "nome": "🟣 GURIA SHAPE ROXO 🟣", "preco": 285.00, "imagem": "https://www.gtfit.store/assets/produtos/roxo.png", "descricao_curta": "Redução do apetite, controle da ansiedade alimentar e melhora do metabolismo para facilitar a perda de peso.", "link_loja": "https://www.gabrielatorraca.com.br/suplementos-naturais/emagrecedores/guria-shape" },
      { "id": 3, "nome": "⚫ GURIA SHAPE BLACK ⚫", "preco": 330.00, "imagem": "https://www.gtfit.store/assets/produtos/black.png", "descricao_curta": "Aceleração da queima de gordura, redução da fome, controle do açúcar no sangue e melhora geral do metabolismo.", "link_loja": "https://www.gabrielatorraca.com.br/suplementos-naturais/emagrecedores/guria-shape-black" },
      { "id": 4, "nome": "🟢 GURIA SHAPE DETOX 🟢", "preco": 175.00, "imagem": "https://www.gtfit.store/assets/produtos/detox.png", "descricao_curta": "Desintoxicação orgânica, redução da inflamação, controle da fome e melhor regulação do metabolismo.", "link_loja": "https://www.gabrielatorraca.com.br/suplementos-naturais/emagrecedores/guria-shape-detox" },
      { "id": 5, "nome": "🟡 GURIA SHAPE GOLD 🟡", "preco": 499.99, "imagem": "https://www.gtfit.store/assets/produtos/gold.png", "descricao_curta": "Ação termogênica avançada, melhora do metabolismo, equilíbrio do apetite e suporte para romper o platô.", "link_loja": "https://www.gabrielatorraca.com.br/suplementos-naturais/emagrecedores/shape-xtreme" }
    ];
