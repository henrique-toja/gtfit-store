...
const produtos = [
    ...
    },
    {
        ...
        "composicao": [
            "Cáscara Sagrada + Sene: Ação laxativa natural leve e controlada. Promovem limpeza intestinal, reduzindo fezes acumuladas e diminuindo o inchaço abdominal.",
            "Pholia Magra + Psyllium: Reduzem a fome desnecessária, aumentam a saciedade e ajudam no controle do apetite sem perda de energia.",
            "Quitosana + Faseolamina: Atuam como bloqueadores naturais de gorduras e carboidratos, evitando o acúmulo de novas calorias e ajudando a secar mais rápido.",
            "Spirulina: Superalimento que preserva a massa magra, melhora os níveis de energia e regula a sensação de fome.",
            "Cúrcuma: Anti-inflamatório natural que acelera o metabolismo e melhora a resposta do corpo ao processo de queima de gordura.",
            "Amora: Ação antioxidante complementar. Não interfere nos hormônios masculinos e contribui com a saúde geral."
        ],
        ...
        "efeitos_possiveis": [
            ...
            "Sensação de alívio e esvaziamento abdominal",
    ...
    {
        "id": 7,
        "nome": "💧 GURIA SHAPE DETOX GOTAS – FÓRMULA NATURAL 4 EM 1 💧",
        "categoria": "Emagrecedores",
    ...
    {
        "id": 8,
        "nome": "🍓 WHEY PROTEIN GURIA SHAPE – SABOR MORANGO 🍓",
    ...
    {
        "id": 11,
        "nome": "🍦 SHAKE SUBSTITUTO DE REFEIÇÃO – SABOR BAUNILHA 🍦",
        "categoria": "Complementos",
    ...
    {
        "id": 12,
        "nome": "🍌 SHAKE SUBSTITUTO DE REFEIÇÃO – SABOR BANANA 🍌",
        "categoria": "Complementos",
    ...
    {
        "id": 13,
        "nome": "🌙 GURIA SHAPE MELATONINA – FILME SUBLINGUAL 🌙",
        "categoria": "Complementos",
    ...
    {
        "id": 15,
        "nome": "🤍 GURIA SHAPE MELASM – CLAREADOR DE MANCHAS 🤍",
        "categoria": "Complementos",
    ...
    {
        "id": 17,
        "nome": "⚪ COLÁGENO HIDROLISADO – LINHA GABRIELA TORRACA ⚪",
        "categoria": "Complementos",
        ...
        <div class="w-full max-w-md mx-auto">
            <div class="product-card-detail">
                <div class="product-detail-header">
                    <img src="${imageUrl}" alt="${produto.nome}" class="w-32 h-32 object-contain rounded-full mx-auto mb-5 border-4 border-primary-purple/50 shadow-lg shadow-primary-purple/20">
